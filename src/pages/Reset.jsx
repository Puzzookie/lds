...
const Reset = () => {
  const { userLoading, user, reset } = useUser();
          ...
          <header className="flex flex-col items-center justify-center">
            ...
            <form onKeyDown={handleKeyDown}>
              ...
              type="button"
                  ...
                  disabled={loading}
                >
                  {loading ? "Sending Password Reset Email..." : "Send Password Reset Email"}
                </button>  
              </div>       
            </form>  
            <footer> 
              <div className="text-center mb-3"> 
                <Link className="text-gray-400 hover:text-indigo-500 text-md" to="/">Return to login</Link> 
              </div> 
            </footer>
